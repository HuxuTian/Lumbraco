...
namespace Lumbraco.Demo.Masterpages
{
    public partial class Site : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //var if1 = new ComputedField() { FieldName = "productName", IndexType = "NOT_ANALYZED", StorageType = "YES", TermVector = "NO", FieldType = "System.String" };
            //var if2 = new ComputedField() { FieldName = "casName", IndexType = "NOT_ANALYZED", StorageType = "YES", TermVector = "NO", FieldType = "System.String" };
